...
?>
    ...
    <main>
            ...
            <div class="add-contact-page">
                ...
                <input type="text" name="add-contact-name" maxlength="255" placeholder="Nama*" required pattern="[A-Za-zñÑçÇáéíóúÁÉÍÓÚ ]+"/>
                <input type="text" name="add-contact-surname" maxlength="255" placeholder="NIM*" required pattern="[A-Za-zñÑçÇáéíóúÁÉÍÓÚ ]+"/>
